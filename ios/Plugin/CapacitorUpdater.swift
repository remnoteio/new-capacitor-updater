...
@objc public class CapacitorUpdater: NSObject {
  ...
  public func download(url: URL, version: String) -> Future<BundleInfo> {
    let promise = Promise<BundleInfo>()
  ...
  public func getBundleInfo(id: String?) -> BundleInfo {
    ...
    if BundleInfo.ID_BUILTIN == trueId {
      ...
      if (obj != nil) {
        ...
        print("\(self.TAG) Failed to parse info for bundle [\(trueId)]")
